  ...
  return (
    <>
      <div className=" py-5 px-12 space-y-6 text-white w-full border-t border-t-slate-400">
        <div className="section1 w-full   flex justify-between  text-3xl text-white">

          <div className="logo py-3 w-[16vw] border-b  boredr-b-slate-700  font-bold leading-10 cursor-pointer">Dil<span className='text-red-600 mx-1.5 '>MOVIES </span>
          </div>


          <div className="social flex mx-7 py-3 w-[16vw] border-b gap-2 boredr-b-slate-700 ">
        ...
        <div className="section2 border-b border-b-slate-400 py-8 text-white text-base flex md:justify-between justify-between flex-wrap">
          <div className="space-y-5">
            <h2 className='text-slate-300 font-semibold '>COMPANY</h2>
            <div className="service leading-tight text-sm">
        ...
        <div className="section3 py-9 space-y-10">
         ...
         <div className="copyright text-slate-300 text-xs">
