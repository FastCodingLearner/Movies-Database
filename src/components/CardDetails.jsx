...
function CardDetails() {
  ...
  return (
   <>
   { value.res ? <Spinner/> : 
   <div className="database w-full p-10 text-white">
    <div className="1 w-full flex flex-wrap gap-x-7 ">
        <img src={data.Poster}alt="" className="rounded-lg" />
        
        <div className="space-y-7 w-[60vw]">
        <div className="">
            <h2 className="font-bold text-5xl my-8">{data.Title}</h2>
        ...
        <div className="space-y-3">
            <h2 className="text-yellow-400 font-semibold text-xl">In Theaters Released {data.Released}</h2>
            <p className="text-lg ">{data.Plot}</p>
        </div>
    <div className="flex justify-between flex-wrap">
        <p className="font-semibold text-xl">Type : <span className="text-slate-300 text-base">{data.Type}</span></p>
        <p className="font-semibold text-xl">Genre : <span className="text-slate-300 text-base">{data.Genre}</span></p>
        <p className="font-semibold text-xl">Language : <span className="text-slate-300 text-base">{data.Language}</span></p>
        <p className="font-semibold text-xl">Country : <span className="text-slate-300 text-base">{data.Country}</span></p>
    </div>
        </div>
    </div>
   </div>
