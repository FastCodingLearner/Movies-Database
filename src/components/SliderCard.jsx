...
const {contentName,contentType,path} = props;
  ...
  return (
    <>
        <h1 className='text-xl font-semibold text-white mx-6 '>{contentName}</h1>
      <div className="bg-transparent text-white  overflow-x-auto px-5 scroll-hidden ">
        <div className="container flex gap-5 w-[100vw] h-[22vw]">
       ...
       <Link to={path} ><div  className="h-[15vw] w-[12vw] space-y-2 flex justify-center items-center border rounded-md border-white cursor-pointer hover:scale-90 transition duration-150 ease-in-out hover:delay-200"  >
