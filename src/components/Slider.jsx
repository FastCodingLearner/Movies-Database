...
function Slider() {
    ...
    return (
        <>
        <Link to='/card-database'><div className='w-[100vw] h-[36vw] overflow-x-auto flex group scroll-hidden cursor-pointer' onClick={sliderHandler}>
            ...
            <div className="scroll h-full  flex space-x-5 animate-scroll  group-hover:pause snap-center ">
              ...
              { value.poster.map((val,i)=>{ 
                return <div key={i} className=" h-full w-[80vw] relative  flex  py-7 ">
                    ...
                    <div className=" absolute bottom-16 left-8 flex items-center gap-3 text-2xl">
