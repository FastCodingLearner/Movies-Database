...
function Navbar() {
    ...
    return (
    <>
            <div className='bg-transparent space-y-3 flex justify-center md:justify-between  px-3 py-5 flex-wrap w-full'>
                <div className="nav1 flex flex-wrap gap-x-12 justify-center md:justify-between text-3xl lg:text-xl items-center ">
                    ...
                    <div className="category  text-white mx-3 md:mx-0">
                        <ul className="flex gap-x-3 flex-wrap md:flex-nowrap justify-center">
