...
function Navbar() {
    ...
    <>
            <div className='bg-transparent space-y-3 flex justify-between  px-3 py-5 flex-wrap'>
                <div className="nav1 flex flex-wrap gap-x-12 justify-center md:justify-between text-lg items-center ">
                    <div className="logo text-white text-3xl font-bold leading-10 cursor-pointer">Dil<span className='text-red-600 mx-1.5 '>MOVIES </span></div>
               ...
               <div className="flex flex-wrap justify-center  md:justify-between  md:items-center md:space-x-7">
                   <div className="nav2 w-[95vw] md:w-[28vw]  text-white border border-white text-lg rounded-2xl flex gap-2 items-center justify-between">
                       <div className="flex items-center">
                        <FaMagnifyingGlass className='text-3xl  ml-2' />
                        <input onChange = {inputHandler} className='px-1 py-2  w-[19vw] bg-transparent outline-none placeholder:text-white' type="text" placeholder='Search Movies Series And Others'  />
                        </div>
                    ...
                    <div className="btn mt-4 md:mt-0 space-x-28 md:space-x-3 text-white text-lg md:flex justify-between items-center">
